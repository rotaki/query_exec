...
pub fn estimate_quantiles<M: MemPool>(
    ...
    match method {
        ...
        QuantileMethod::TPCH_100_2 => match num_quantiles_per_run {
            ...
            9 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 4, 224],
                vec![0, 0, 0, 0, 0, 0, 0, 9, 201],
                vec![0, 0, 0, 0, 0, 0, 0, 14, 174],
                vec![0, 0, 0, 0, 0, 0, 0, 19, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 24, 116],
                vec![0, 0, 0, 0, 0, 0, 0, 29, 73],
                vec![0, 0, 0, 0, 0, 0, 0, 34, 45],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            ...
            16 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                // Using the second provided version for 16:
                vec![0, 0, 0, 0, 0, 0, 0, 2, 118],
                vec![0, 0, 0, 0, 0, 0, 0, 4, 224],
                vec![0, 0, 0, 0, 0, 0, 0, 7, 86],
                vec![0, 0, 0, 0, 0, 0, 0, 9, 201],
                vec![0, 0, 0, 0, 0, 0, 0, 12, 66],
                vec![0, 0, 0, 0, 0, 0, 0, 14, 174],
                vec![0, 0, 0, 0, 0, 0, 0, 17, 35],
                vec![0, 0, 0, 0, 0, 0, 0, 19, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 22, 2],
                vec![0, 0, 0, 0, 0, 0, 0, 24, 116],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 229],
                vec![0, 0, 0, 0, 0, 0, 0, 29, 73],
                vec![0, 0, 0, 0, 0, 0, 0, 31, 186],
                vec![0, 0, 0, 0, 0, 0, 0, 34, 45],
                vec![0, 0, 0, 0, 0, 0, 0, 36, 160],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            17 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 2, 82],
                vec![0, 0, 0, 0, 0, 0, 0, 4, 154],
                vec![0, 0, 0, 0, 0, 0, 0, 6, 230],
                vec![0, 0, 0, 0, 0, 0, 0, 9, 53],
                vec![0, 0, 0, 0, 0, 0, 0, 11, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 13, 213],
                vec![0, 0, 0, 0, 0, 0, 0, 16, 28],
                vec![0, 0, 0, 0, 0, 0, 0, 18, 105],
                vec![0, 0, 0, 0, 0, 0, 0, 20, 180],
                vec![0, 0, 0, 0, 0, 0, 0, 23, 2],
                vec![0, 0, 0, 0, 0, 0, 0, 25, 82],
                vec![0, 0, 0, 0, 0, 0, 0, 27, 153],
                vec![0, 0, 0, 0, 0, 0, 0, 29, 219],
                vec![0, 0, 0, 0, 0, 0, 0, 32, 37],
                vec![0, 0, 0, 0, 0, 0, 0, 34, 121],
                vec![0, 0, 0, 0, 0, 0, 0, 36, 195],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            _ => Vec::new(),
        },
