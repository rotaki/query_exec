...
impl QuantileMethod {
    pub fn to_string(&self) -> String {
        match self {
            ...
            QuantileMethod::TPCH_100_2 => "TPCH_2".to_string(),
    ...
    pub fn from_string(s: &str) -> Option<Self> {
        match s.to_uppercase().as_str() {
            ...
            "TPCH_100_2" => Some(QuantileMethod::TPCH_100_2),
            _ => None,
        }
    }
}
...
pub fn estimate_quantiles<M: MemPool>(
    ...
    match method {
        ...
        QuantileMethod::TPCH_100 => match num_quantiles_per_run {
            ...
            4 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 13, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 20],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            5 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
            ...
            6 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 7, 212],
                vec![0, 0, 0, 0, 0, 0, 0, 15, 171],
                vec![0, 0, 0, 0, 0, 0, 0, 23, 120],
                vec![0, 0, 0, 0, 0, 0, 0, 31, 60],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            7 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 6, 134],
                vec![0, 0, 0, 0, 0, 0, 0, 13, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 19, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 20],
                vec![0, 0, 0, 0, 0, 0, 0, 32, 134],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            8 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 5, 150],
                vec![0, 0, 0, 0, 0, 0, 0, 11, 51],
                vec![0, 0, 0, 0, 0, 0, 0, 16, 198],
                vec![0, 0, 0, 0, 0, 0, 0, 22, 93],
                vec![0, 0, 0, 0, 0, 0, 0, 27, 236],
                vec![0, 0, 0, 0, 0, 0, 0, 33, 118],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            9 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
            ...
            10 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 4, 86],
                vec![0, 0, 0, 0, 0, 0, 0, 8, 178],
                vec![0, 0, 0, 0, 0, 0, 0, 13, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 17, 108],
                vec![0, 0, 0, 0, 0, 0, 0, 21, 189],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 20],
                vec![0, 0, 0, 0, 0, 0, 0, 30, 93],
                vec![0, 0, 0, 0, 0, 0, 0, 34, 185],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            11 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 3, 233],
                vec![0, 0, 0, 0, 0, 0, 0, 7, 212],
                vec![0, 0, 0, 0, 0, 0, 0, 11, 197],
                vec![0, 0, 0, 0, 0, 0, 0, 15, 171],
                vec![0, 0, 0, 0, 0, 0, 0, 19, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 23, 120],
                vec![0, 0, 0, 0, 0, 0, 0, 27, 95],
                vec![0, 0, 0, 0, 0, 0, 0, 31, 60],
                vec![0, 0, 0, 0, 0, 0, 0, 35, 40],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            12 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 3, 145],
                vec![0, 0, 0, 0, 0, 0, 0, 7, 27],
                vec![0, 0, 0, 0, 0, 0, 0, 10, 173],
                vec![0, 0, 0, 0, 0, 0, 0, 14, 64],
                vec![0, 0, 0, 0, 0, 0, 0, 17, 207],
                vec![0, 0, 0, 0, 0, 0, 0, 21, 88],
                vec![0, 0, 0, 0, 0, 0, 0, 24, 229],
                vec![0, 0, 0, 0, 0, 0, 0, 28, 104],
                vec![0, 0, 0, 0, 0, 0, 0, 31, 240],
                vec![0, 0, 0, 0, 0, 0, 0, 35, 127],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            13 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 3, 69],
                vec![0, 0, 0, 0, 0, 0, 0, 6, 134],
                vec![0, 0, 0, 0, 0, 0, 0, 9, 201],
                vec![0, 0, 0, 0, 0, 0, 0, 13, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 16, 77],
                vec![0, 0, 0, 0, 0, 0, 0, 19, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 22, 209],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 20],
                vec![0, 0, 0, 0, 0, 0, 0, 29, 73],
                vec![0, 0, 0, 0, 0, 0, 0, 32, 134],
            ...
            14 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 3, 5],
                vec![0, 0, 0, 0, 0, 0, 0, 6, 5],
                vec![0, 0, 0, 0, 0, 0, 0, 9, 6],
                vec![0, 0, 0, 0, 0, 0, 0, 12, 18],
                vec![0, 0, 0, 0, 0, 0, 0, 15, 14],
                vec![0, 0, 0, 0, 0, 0, 0, 18, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 21, 15],
                vec![0, 0, 0, 0, 0, 0, 0, 24, 18],
                vec![0, 0, 0, 0, 0, 0, 0, 27, 21],
                vec![0, 0, 0, 0, 0, 0, 0, 30, 5],
                vec![0, 0, 0, 0, 0, 0, 0, 33, 9],
                vec![0, 0, 0, 0, 0, 0, 0, 36, 16],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            15 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 2, 210],
                vec![0, 0, 0, 0, 0, 0, 0, 5, 150],
                vec![0, 0, 0, 0, 0, 0, 0, 8, 102],
                vec![0, 0, 0, 0, 0, 0, 0, 11, 51],
                vec![0, 0, 0, 0, 0, 0, 0, 13, 255],
                vec![0, 0, 0, 0, 0, 0, 0, 16, 198],
                vec![0, 0, 0, 0, 0, 0, 0, 19, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 22, 93],
                vec![0, 0, 0, 0, 0, 0, 0, 25, 39],
                vec![0, 0, 0, 0, 0, 0, 0, 27, 236],
                vec![0, 0, 0, 0, 0, 0, 0, 30, 173],
                vec![0, 0, 0, 0, 0, 0, 0, 33, 118],
                vec![0, 0, 0, 0, 0, 0, 0, 36, 71],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            16 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 2, 160],
                vec![0, 0, 0, 0, 0, 0, 0, 5, 53],
                vec![0, 0, 0, 0, 0, 0, 0, 7, 212],
                vec![0, 0, 0, 0, 0, 0, 0, 10, 114],
                vec![0, 0, 0, 0, 0, 0, 0, 13, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 15, 171],
                vec![0, 0, 0, 0, 0, 0, 0, 18, 68],
                vec![0, 0, 0, 0, 0, 0, 0, 20, 219],
                vec![0, 0, 0, 0, 0, 0, 0, 23, 120],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 20],
                vec![0, 0, 0, 0, 0, 0, 0, 28, 165],
                vec![0, 0, 0, 0, 0, 0, 0, 31, 60],
                vec![0, 0, 0, 0, 0, 0, 0, 33, 215],
                vec![0, 0, 0, 0, 0, 0, 0, 36, 119],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 16],
            ],
            17 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
        ...
        QuantileMethod::TPCH_100_2 => match num_quantiles_per_run {
            2 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            3 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 15],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            4 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 52, 28],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            5 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 19, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 15],
                vec![0, 0, 0, 0, 0, 0, 0, 58, 145],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            6 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 15, 164],
                vec![0, 0, 0, 0, 0, 0, 0, 31, 73],
                vec![0, 0, 0, 0, 0, 0, 0, 46, 225],
                vec![0, 0, 0, 0, 0, 0, 0, 62, 123],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            7 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 13, 7],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 15],
                vec![0, 0, 0, 0, 0, 0, 0, 52, 28],
                vec![0, 0, 0, 0, 0, 0, 0, 65, 21],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            8 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 11, 43],
                vec![0, 0, 0, 0, 0, 0, 0, 22, 90],
                vec![0, 0, 0, 0, 0, 0, 0, 33, 134],
                vec![0, 0, 0, 0, 0, 0, 0, 44, 169],
                vec![0, 0, 0, 0, 0, 0, 0, 55, 206],
                vec![0, 0, 0, 0, 0, 0, 0, 66, 239],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            9 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 9, 194],
                vec![0, 0, 0, 0, 0, 0, 0, 19, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 29, 82],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 15],
                vec![0, 0, 0, 0, 0, 0, 0, 48, 217],
                vec![0, 0, 0, 0, 0, 0, 0, 58, 145],
                vec![0, 0, 0, 0, 0, 0, 0, 68, 91],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            10 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 8, 171],
                vec![0, 0, 0, 0, 0, 0, 0, 17, 97],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 34, 202],
                vec![0, 0, 0, 0, 0, 0, 0, 43, 104],
                vec![0, 0, 0, 0, 0, 0, 0, 52, 28],
                vec![0, 0, 0, 0, 0, 0, 0, 60, 190],
                vec![0, 0, 0, 0, 0, 0, 0, 69, 112],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            11 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 7, 204],
                vec![0, 0, 0, 0, 0, 0, 0, 15, 164],
                vec![0, 0, 0, 0, 0, 0, 0, 23, 119],
                vec![0, 0, 0, 0, 0, 0, 0, 31, 73],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 15],
                vec![0, 0, 0, 0, 0, 0, 0, 46, 225],
                vec![0, 0, 0, 0, 0, 0, 0, 54, 180],
                vec![0, 0, 0, 0, 0, 0, 0, 62, 123],
                vec![0, 0, 0, 0, 0, 0, 0, 70, 83],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            12 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 7, 25],
                vec![0, 0, 0, 0, 0, 0, 0, 14, 52],
                vec![0, 0, 0, 0, 0, 0, 0, 21, 81],
                vec![0, 0, 0, 0, 0, 0, 0, 28, 111],
                vec![0, 0, 0, 0, 0, 0, 0, 35, 146],
                vec![0, 0, 0, 0, 0, 0, 0, 42, 161],
                vec![0, 0, 0, 0, 0, 0, 0, 49, 186],
                vec![0, 0, 0, 0, 0, 0, 0, 56, 201],
                vec![0, 0, 0, 0, 0, 0, 0, 63, 230],
                vec![0, 0, 0, 0, 0, 0, 0, 71, 6],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            13 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 6, 130],
                vec![0, 0, 0, 0, 0, 0, 0, 13, 7],
                vec![0, 0, 0, 0, 0, 0, 0, 19, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 32, 144],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 15],
                vec![0, 0, 0, 0, 0, 0, 0, 45, 148],
                vec![0, 0, 0, 0, 0, 0, 0, 52, 28],
                vec![0, 0, 0, 0, 0, 0, 0, 58, 145],
                vec![0, 0, 0, 0, 0, 0, 0, 65, 21],
                vec![0, 0, 0, 0, 0, 0, 0, 71, 162],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            14 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 6, 3],
                vec![0, 0, 0, 0, 0, 0, 0, 12, 6],
                vec![0, 0, 0, 0, 0, 0, 0, 18, 10],
                vec![0, 0, 0, 0, 0, 0, 0, 24, 16],
                vec![0, 0, 0, 0, 0, 0, 0, 30, 15],
                vec![0, 0, 0, 0, 0, 0, 0, 36, 25],
                vec![0, 0, 0, 0, 0, 0, 0, 42, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 48, 23],
                vec![0, 0, 0, 0, 0, 0, 0, 54, 31],
                vec![0, 0, 0, 0, 0, 0, 0, 60, 16],
                vec![0, 0, 0, 0, 0, 0, 0, 66, 20],
                vec![0, 0, 0, 0, 0, 0, 0, 72, 38],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            15 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 5, 156],
                vec![0, 0, 0, 0, 0, 0, 0, 11, 43],
                vec![0, 0, 0, 0, 0, 0, 0, 16, 202],
                vec![0, 0, 0, 0, 0, 0, 0, 22, 90],
                vec![0, 0, 0, 0, 0, 0, 0, 27, 237],
                vec![0, 0, 0, 0, 0, 0, 0, 33, 134],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 15],
                vec![0, 0, 0, 0, 0, 0, 0, 44, 169],
                vec![0, 0, 0, 0, 0, 0, 0, 50, 62],
                vec![0, 0, 0, 0, 0, 0, 0, 55, 206],
                vec![0, 0, 0, 0, 0, 0, 0, 61, 93],
                vec![0, 0, 0, 0, 0, 0, 0, 66, 239],
                vec![0, 0, 0, 0, 0, 0, 0, 72, 146],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            16 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 5, 61],
                vec![0, 0, 0, 0, 0, 0, 0, 10, 103],
                vec![0, 0, 0, 0, 0, 0, 0, 15, 164],
                vec![0, 0, 0, 0, 0, 0, 0, 20, 219],
                vec![0, 0, 0, 0, 0, 0, 0, 26, 19],
                vec![0, 0, 0, 0, 0, 0, 0, 31, 73],
                vec![0, 0, 0, 0, 0, 0, 0, 36, 125],
                vec![0, 0, 0, 0, 0, 0, 0, 41, 172],
                vec![0, 0, 0, 0, 0, 0, 0, 46, 225],
                vec![0, 0, 0, 0, 0, 0, 0, 52, 28],
                vec![0, 0, 0, 0, 0, 0, 0, 57, 68],
                vec![0, 0, 0, 0, 0, 0, 0, 62, 123],
                vec![0, 0, 0, 0, 0, 0, 0, 67, 178],
                vec![0, 0, 0, 0, 0, 0, 0, 72, 242],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            17 => vec![
                vec![0, 0, 0, 0, 0, 0, 0, 0, 1],
                vec![0, 0, 0, 0, 0, 0, 0, 4, 232],
                vec![0, 0, 0, 0, 0, 0, 0, 9, 194],
                vec![0, 0, 0, 0, 0, 0, 0, 14, 168],
                vec![0, 0, 0, 0, 0, 0, 0, 19, 139],
                vec![0, 0, 0, 0, 0, 0, 0, 24, 113],
                vec![0, 0, 0, 0, 0, 0, 0, 29, 82],
                vec![0, 0, 0, 0, 0, 0, 0, 34, 59],
                vec![0, 0, 0, 0, 0, 0, 0, 39, 15],
                vec![0, 0, 0, 0, 0, 0, 0, 43, 242],
                vec![0, 0, 0, 0, 0, 0, 0, 48, 217],
                vec![0, 0, 0, 0, 0, 0, 0, 53, 189],
                vec![0, 0, 0, 0, 0, 0, 0, 58, 145],
                vec![0, 0, 0, 0, 0, 0, 0, 63, 117],
                vec![0, 0, 0, 0, 0, 0, 0, 68, 91],
                vec![0, 0, 0, 0, 0, 0, 0, 73, 67],
                vec![0, 0, 0, 0, 0, 0, 0, 78, 32],
            ],
            _ => mean_based_quantiles(runs, num_quantiles_per_run),
        },
